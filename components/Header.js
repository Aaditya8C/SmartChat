  ...
  return (
    <div className="bg-[#161616] text-white py-2 md:py-4 tracking-wide border-b border-gray-600 sticky top-0 z-50">
      <div className="max-w-[90%] lg:max-w-[55%] mx-auto flex justify-between items-center">
        <div
          className="flex gap-2 justify-center items-center lg:cursor-pointer"
        ...
        <div className="flex gap-4">
          ...
          <button
            className="bg-[#262626] rounded-md p-2 md:p-3 w-fit lg:cursor-pointer shrink-0 hover:bg-[#414040] transition-all duration-300"
